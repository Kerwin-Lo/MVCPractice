namespace MVCPractice.Models
{
	public static class RepositoryHelper
	{
		...
		public static VW_客戶摘要資訊Repository GetVW_客戶摘要資訊Repository()
		{
			var repository = new VW_客戶摘要資訊Repository();
			repository.UnitOfWork = GetUnitOfWork();
			return repository;
		}

		public static VW_客戶摘要資訊Repository GetVW_客戶摘要資訊Repository(IUnitOfWork unitOfWork)
		{
			var repository = new VW_客戶摘要資訊Repository();
